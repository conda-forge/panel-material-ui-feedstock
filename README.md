About panel-material-ui-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/panel-material-ui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/panel-material-ui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add panel-material-ui
# for installing globally
pixi global install panel-material-ui
```
...
It is possible to list all of the versions of `panel-material-ui` available on your platform:
...
```
pixi search panel-material-ui --channel conda-forge
```
